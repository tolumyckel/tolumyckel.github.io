function showdet(name){
    ...
    She is the CEO of ronique events, an event planning enterprise and works as a human resource person with a tech company. Ayo is based in Ottawa, Ontario.`,
                   'yinka':'Hmm, how do I describe this man? Yinka "my guys"! Yinka is a brother that I never knew I needed. Him coming into my life has made me appreciate the essence of brotherhood. He is a wonderful man who fears the Lord in his deeds and consider him one of the wise men I know.  He works with a building company as a designer, and lives happily in Ottawa, with his wife, Tega Alao.',
                   'iyanu':`Iyanu is another wonderful sister that heaven has blessed me with. Without a shadow of doubt, I know this relationship was carefully handpicked and orchestrated by God, yet to see its best days. 
                   She is a lovely, highly intelligent and disciplined woman. Iyanu isn't passionate about too many things but her passion for God is hard to ignore. From being good friends in Unilorin to becoming neighbours in a foreign country, I'm certain this relationship is here to stay. She is a business analyst by profession and resides in Calgary, Alberta.`,
